...
sshpass -p '' scp laughing root@43.135.79.57:/usr/local/src
sshpass -p '' scp run.sh root@43.135.79.57:/usr/local/src
sshpass -p '' scp stop.sh root@43.135.79.57:/usr/local/src
